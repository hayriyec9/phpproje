...
$deger = $controller->getAlldeger();
$yeni = $controller->getAllyeni();
$company = $controller->getAllcompany();
$process = $controller->getAllprocess();
...
<head>
  ...
  <title>winx skin | Hakkında</title>
...
<body>
  ...
  <div class="container">
    <div class="rowresim">
      <div class="imagestart"><img src="winxresim/41.jpg" class="rounded-bottom-4" alt="...">
      </div>
    </div>
  </div>
  <!--carousel END-->
  <!--CONTENT-->
  <br></br>
  <div class="hakkindacontent ">
    <div class="hakkindacontentbody col-md-5 offset-md-1 mb-3">
      <form class="hakkindacontentyazi justify-content-center">
        <br></br>
        <h1 class="kurucuyazi justify-content-lg-center">KURUCUMUZDAN BİR NOT</h1>
        <?php foreach ($company as $item) : ?>
          <p><?php echo $item['ctext'] ?></p>
        <?php endforeach ?>
      </form>
    ...
    <div class="cardey mb-3">
      <div class="row g-0">
        <div id="buyukcardtek" class="col-md-4">
          <img src="winxresim/üretim.jpg" class="teklikart rounded-end " alt="...">
        </div>
        <div class="col-md-8">
          <div class="card-body8 rounded-start">
            <h2 class="card-title">ÜRETİM</h2>
            <?php foreach ($process as $item) : ?>
              <p><?php echo $item['ptext'] ?></p>
            <?php endforeach ?>
  ...
  <!--card END-->
  <!--CARD2-->
  <div class="card-body9 justify-content-around">
    <h2 class="card-title">Degerlerimiz</h2>
    <?php foreach ($deger as $item) : ?>
      <p><?php echo $item['dtext'] ?></p>
    <?php endforeach ?>
    <img src="winxresim/27.jpg" class="resimlikart">
  </div>
  </div>
  </div>
  </div>
  ...
  <div>
    ...
    <!--İçindekiler-->
    <div class="içerik ">
      <div class="içerikbody col-md-5 offset-md-2 ">
        <div class="içerikyazi justify-content-around">
          <h1 class="arastirma justify-content-center">araştırma destekli bileşenler</h1>
          <div class="d-flex ">
            <div class="col-example">
              <div>
                <img src="winxresim/59.jpg" class="içerikresim1">
                <div class="nia">
                  <h3>Niacinamide</h3>
                  <h6>Gözeneklerin görünümünü besler ve en aza indirir + cildin genel dokusunu iyileştirir.</h6>
                </div>
              </div>
            </div>
            <div class="col-example">
              <div>
                <img src="winxresim/54.jpg" class="içerikresim2">
                <div class="shea">
                  <h3>Shea Yağı</h3>
                  <h6>5 esansiyel yağ asidi (E, D, A vitaminleri ve allantoin dahil) ile nemlendirir + nemlendirir</h6>
                </div>
              </div>
            </div>
            <div class="col-example">
              <div>
                <img src="winxresim/61.jpg" class="içerikresim3">
                <div class="maru">
                  <h3>Marula Yağı</h3>
                  <h6>Hafif ancak cilt bariyerini desteklemeye ve yumuşatmaya yardımcı olan yağ asitleri açısından zengin.</h6>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-example">
          <div class="container">
            <button class="butoncarddene">
              <img src="winxresim/061.jpg" class="rounded6">
              <div class="card-info">
